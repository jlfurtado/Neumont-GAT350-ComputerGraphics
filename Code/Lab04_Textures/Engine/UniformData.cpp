...
namespace Engine
{
	...
	UniformData::UniformData(GLenum type, void * dataAddress, int dataLoc)
		: m_uniformType(type), m_pUniformData(dataAddress), m_uniformDataLoc(dataLoc)
	{
	}
