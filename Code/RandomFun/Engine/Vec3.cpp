...
namespace Engine
{
	...
	bool Vec3::EqualsWithinTolerance(const Vec3 & other, float tolerance) const
	{
		return (fabsf(m_values[0] - other.m_values[0]) < tolerance) && (fabsf(m_values[1] - other.m_values[1]) < tolerance) && (fabsf(m_values[2] - other.m_values[2]) < tolerance);
	}
