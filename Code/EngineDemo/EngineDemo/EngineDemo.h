...
public:
	...
	static void PCCallback(Engine::GraphicalObject *instance, void *classInstance);
	static void PTCallback(Engine::GraphicalObject *instance, void *classInstance);
	static void DiffuseCallback(Engine::GraphicalObject *instance, void *classInstance);
	static void DebugCallback(Engine::GraphicalObject *instance, void *classInstance);
	static const float RENDER_DISTANCE;

private:
	// methods
	static void PassMatrix(Engine::GraphicalObject *instance, void *classInstance);
	static void PassTint(Engine::GraphicalObject *instance, void *classInstance);
