...
bool EngineDemo::Initialize(Engine::MyWindow *window)
{
	...
	Engine::ShapeGenerator::ReadSceneFile("..\\Data\\Scenes\\BetterDargon.PN.scene", &playerGraphicalObject, m_shaderPrograms[4].GetProgramId());
	...
	playerGraphicalObject.AddUniformData(Engine::UniformData(GL_FLOAT_MAT4, &vpm, vpmLoc));
	...
	playerGraphicalObject.AddUniformData(Engine::UniformData(GL_FLOAT, &lineWidth, lineWidthLoc));
	playerGraphicalObject.AddUniformData(Engine::UniformData(GL_FLOAT_VEC4, &lineColor, lineColorLoc));
	...
	Engine::ShapeGenerator::CreatePoints(&m_demoObjects[17], numParticles, Engine::Vec3(-cubeSize), Engine::Vec3(cubeSize), m_shaderPrograms[3].GetProgramId(), true, Engine::Vec3(0.0f, 1.0f, 0.0f));
	Engine::RenderEngine::AddGraphicalObject(&m_demoObjects[17]);
	m_demoObjects[17].AddPhongUniforms(modelToWorldMatLoc, worldToViewMatLoc, playerCamera.GetWorldToViewMatrixPtr()->GetAddress(), perspectiveMatLoc, m_perspective.GetPerspectivePtr()->GetAddress(),
		tintColorLoc, diffuseColorLoc, ambientColorLoc, specularColorLoc, specularPowerLoc, diffuseIntensityLoc, ambientIntensityLoc, specularIntensityLoc,
		&playerGraphicalObject.GetMatPtr()->m_materialColor, cameraPosLoc, playerCamera.GetPosPtr(), lightLoc, m_lights[0].GetLocPtr());

	m_demoObjects[17].AddUniformData(Engine::UniformData(GL_FLOAT, &halfWidth, halfWidthLoc));
	m_demoObjects[17].AddUniformData(Engine::UniformData(GL_TEXTURE0, &fractalGradientAlternateTextureID, texLoc));
	m_demoObjects[17].AddUniformData(Engine::UniformData(GL_FLOAT_VEC2, &fractalSeed, shaderOffsetLoc));
	m_demoObjects[17].AddUniformData(Engine::UniformData(GL_FLOAT, &repeatScale, repeatScaleLoc));
	m_demoObjects[17].AddUniformData(Engine::UniformData(GL_INT, &numIterations, numIterationsLoc));
	m_demoObjects[17].SetRotationAxis(Engine::Vec3(1.0f));
	m_demoObjects[17].SetRotationRate(Engine::MathUtility::ToRadians(degreesPerSecond));
	m_demoObjects[17].GetMatPtr()->m_specularIntensity = 0.0f;
	m_demoObjects[17].GetMatPtr()->m_ambientReflectivity = Engine::Vec3(0.1f);
	m_demoObjects[17].GetMatPtr()->m_diffuseReflectivity = Engine::Vec3(0.7f);
	m_demoObjects[17].GetMatPtr()->m_specularReflectivity = Engine::Vec3(0.1f);

	Engine::ShapeGenerator::CreatePoints(&m_demoObjects[16], numParticles, Engine::Vec3(-cubeSize), Engine::Vec3(cubeSize), m_shaderPrograms[3].GetProgramId(), true, Engine::Vec3(0.0f, 1.0f, 0.0f));
	Engine::RenderEngine::AddGraphicalObject(&m_demoObjects[16]);
	m_demoObjects[16].AddPhongUniforms(modelToWorldMatLoc, worldToViewMatLoc, playerCamera.GetWorldToViewMatrixPtr()->GetAddress(), perspectiveMatLoc, m_perspective.GetPerspectivePtr()->GetAddress(),
		tintColorLoc, diffuseColorLoc, ambientColorLoc, specularColorLoc, specularPowerLoc, diffuseIntensityLoc, ambientIntensityLoc, specularIntensityLoc,
		&playerGraphicalObject.GetMatPtr()->m_materialColor, cameraPosLoc, playerCamera.GetPosPtr(), lightLoc, m_lights[0].GetLocPtr());
	m_demoObjects[16].AddUniformData(Engine::UniformData(GL_FLOAT, &halfWidth, halfWidthLoc));
	m_demoObjects[16].AddUniformData(Engine::UniformData(GL_TEXTURE0, &fractalGradientTextureID, texLoc));
	m_demoObjects[16].AddUniformData(Engine::UniformData(GL_FLOAT_VEC2, &fractalSeed, shaderOffsetLoc));
	m_demoObjects[16].AddUniformData(Engine::UniformData(GL_FLOAT, &repeatScale, repeatScaleLoc));
	m_demoObjects[16].AddUniformData(Engine::UniformData(GL_INT, &numIterations, numIterationsLoc));
	m_demoObjects[16].SetRotationAxis(Engine::Vec3(1.0f));
	m_demoObjects[16].SetRotationRate(Engine::MathUtility::ToRadians(-degreesPerSecond));
	m_demoObjects[16].GetMatPtr()->m_specularIntensity = 0.0f;
	m_demoObjects[16].GetMatPtr()->m_ambientReflectivity = Engine::Vec3(0.1f);
	m_demoObjects[16].GetMatPtr()->m_diffuseReflectivity = Engine::Vec3(0.7f);
	m_demoObjects[16].GetMatPtr()->m_specularReflectivity = Engine::Vec3(0.1f);

	Engine::ShapeGenerator::MakeDebugCube(&m_demoObjects[15], Engine::Vec3(0.0f, 0.0f, 1.0f));
	Engine::RenderEngine::AddGraphicalObject(&m_demoObjects[15]);
	m_demoObjects[15].AddUniformData(Engine::UniformData(GL_FLOAT_MAT4, m_demoObjects[15].GetFullTransformPtr(), modelToWorldMatLoc));
	m_demoObjects[15].AddUniformData(Engine::UniformData(GL_FLOAT_MAT4, playerCamera.GetWorldToViewMatrixPtr()->GetAddress(), worldToViewMatLoc));
	m_demoObjects[15].AddUniformData(Engine::UniformData(GL_FLOAT_MAT4, m_perspective.GetPerspectivePtr()->GetAddress(), perspectiveMatLoc));
	m_demoObjects[15].AddUniformData(Engine::UniformData(GL_FLOAT_VEC3, &m_demoObjects[15].GetMatPtr()->m_materialColor, tintColorLoc));
	m_demoObjects[15].AddUniformData(Engine::UniformData(GL_FLOAT, &m_demoObjects[15].GetMatPtr()->m_specularIntensity, tintIntensityLoc));
	m_demoObjects[15].SetRotationAxis(Engine::Vec3(1.0f));
	m_demoObjects[15].SetRotationRate(Engine::MathUtility::ToRadians(degreesPerSecond));
	m_demoObjects[15].SetScaleMat(Engine::Mat4::Scale(1000.0f));

	Engine::ShapeGenerator::MakeDebugCube(&m_demoObjects[14], Engine::Vec3(1.0f, 1.0f, 0.0f));
	Engine::RenderEngine::AddGraphicalObject(&m_demoObjects[14]);
	m_demoObjects[14].AddUniformData(Engine::UniformData(GL_FLOAT_MAT4, m_demoObjects[14].GetFullTransformPtr(), modelToWorldMatLoc));
	m_demoObjects[14].AddUniformData(Engine::UniformData(GL_FLOAT_MAT4, playerCamera.GetWorldToViewMatrixPtr()->GetAddress(), worldToViewMatLoc));
	m_demoObjects[14].AddUniformData(Engine::UniformData(GL_FLOAT_MAT4, m_perspective.GetPerspectivePtr()->GetAddress(), perspectiveMatLoc));
	m_demoObjects[14].AddUniformData(Engine::UniformData(GL_FLOAT_VEC3, &m_demoObjects[14].GetMatPtr()->m_materialColor, tintColorLoc));
	m_demoObjects[14].AddUniformData(Engine::UniformData(GL_FLOAT, &m_demoObjects[14].GetMatPtr()->m_specularIntensity, tintIntensityLoc));
	m_demoObjects[14].SetRotationAxis(Engine::Vec3(1.0f));
	m_demoObjects[14].SetRotationRate(Engine::MathUtility::ToRadians(-degreesPerSecond));
	m_demoObjects[14].SetScaleMat(Engine::Mat4::Scale(1000.0f));

	Engine::ShapeGenerator::ReadSceneFile("..\\Data\\Scenes\\Teapot.PN.scene", &m_demoObjects[13], m_shaderPrograms[5].GetProgramId());
	Engine::RenderEngine::AddGraphicalObject(&m_demoObjects[13]);
	m_demoObjects[13].AddUniformData(Engine::UniformData(GL_FLOAT_MAT4, m_demoObjects[13].GetFullTransformPtr(), modelToWorldMatLoc));
	m_demoObjects[13].AddUniformData(Engine::UniformData(GL_FLOAT_MAT4, playerCamera.GetWorldToViewMatrixPtr()->GetAddress(), worldToViewMatLoc));
	m_demoObjects[13].AddUniformData(Engine::UniformData(GL_FLOAT_MAT4, m_perspective.GetPerspectivePtr()->GetAddress(), perspectiveMatLoc));
	m_demoObjects[13].AddUniformData(Engine::UniformData(GL_FLOAT_VEC3, &triangleColor, tintColorLoc));
	m_demoObjects[13].AddUniformData(Engine::UniformData(GL_FLOAT_VEC3, &vertexNormalColor, vColorLoc));
	m_demoObjects[13].AddUniformData(Engine::UniformData(GL_FLOAT_VEC3, &faceNormalColor, fColorLoc));
	m_demoObjects[13].AddUniformData(Engine::UniformData(GL_FLOAT, &hairLength, hairLengthLoc));
	m_demoObjects[13].AddUniformData(Engine::UniformData(GL_INT, &cycleHairMode, cycleHairModeLoc));
	m_demoObjects[13].SetScaleMat(Engine::Mat4::Scale(10.0f));

	Engine::ShapeGenerator::ReadSceneFile("..\\Data\\Scenes\\Teapot.PN.scene", &m_demoObjects[12], m_shaderPrograms[6].GetProgramId());
	Engine::RenderEngine::AddGraphicalObject(&m_demoObjects[12]);
	m_demoObjects[12].AddUniformData(Engine::UniformData(GL_FLOAT_MAT4, m_demoObjects[12].GetFullTransformPtr(), modelToWorldMatLoc));
	m_demoObjects[12].AddUniformData(Engine::UniformData(GL_FLOAT_MAT4, playerCamera.GetWorldToViewMatrixPtr()->GetAddress(), worldToViewMatLoc));
	m_demoObjects[12].AddUniformData(Engine::UniformData(GL_FLOAT_MAT4, m_perspective.GetPerspectivePtr()->GetAddress(), perspectiveMatLoc));
	m_demoObjects[12].AddUniformData(Engine::UniformData(GL_FLOAT, &explodeDist, explodeDistLoc));
	m_demoObjects[12].SetScaleMat(Engine::Mat4::Scale(10.0f));
	m_demoObjects[12].SetTransMat(Engine::Mat4::Translation(Engine::Vec3(50.0f, 50.0f, 50.0f)));
...
bool EngineDemo::InitializeGL()
{
	...
	{					 
		m_shaderPrograms[3].AddVertexShader("..\\Data\\Shaders\\Billboard.vert.shader");
		m_shaderPrograms[3].AddGeometryShader("..\\Data\\Shaders\\Billboard.geom.shader");
		m_shaderPrograms[3].AddFragmentShader("..\\Data\\Shaders\\Billboard.frag.shader");
	...
	{					 
		m_shaderPrograms[4].AddVertexShader("..\\Data\\Shaders\\Wireframe.vert.shader");
		m_shaderPrograms[4].AddGeometryShader("..\\Data\\Shaders\\Wireframe.geom.shader");
		m_shaderPrograms[4].AddFragmentShader("..\\Data\\Shaders\\Wireframe.frag.shader");
