...
namespace Engine
{
	...
	public:
		...
		static bool ReadSceneFile(const char *fileName, GraphicalObject *pObject, GLint shaderProgramID, const char *texturePath = nullptr);
	...
	private:
		...
		static Mesh *FindMeshBySceneString(const char *const sceneName);
		static bool AddMesh(const char *const sceneName, Mesh *pMeshToAdd);
		static bool SetupSceneFile(const char *fileName, GLint shaderProgramID, const char *texturePath = nullptr);
